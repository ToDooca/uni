...
// Model for User entity
    models.User = Backbone.Model.extend({
        urlRoot: "http://localhost:29373/CS230-PZ-3611/webresources/dusanstankovic3611.cs230.entity.user/",
        idAttribute: 'userid',
        defaults: {
            firstname: "",
            password: "",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:29373/CS230-PZ-3611/webresources/dusanstankovic3611.cs230.entity.user/';
            }
    ...
    models.UserCollection = Backbone.Collection.extend({
        model: models.User,
        url: "http://localhost:29373/CS230-PZ-3611/webresources/dusanstankovic3611.cs230.entity.user/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
