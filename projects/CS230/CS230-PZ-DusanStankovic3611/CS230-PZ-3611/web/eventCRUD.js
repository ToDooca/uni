...
// Model for Event entity
    models.Event = Backbone.Model.extend({
        urlRoot: "http://localhost:29373/CS230-PZ-3611/webresources/dusanstankovic3611.cs230.entity.event/",
        idAttribute: 'eventid',
        defaults: {
            eventtitle: "",
            eventtext: "",
        ...
        toViewJson: function () {
            ...
            result.displayName = this.get('eventid');
            return result;
        },
        isNew: function () {
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:29373/CS230-PZ-3611/webresources/dusanstankovic3611.cs230.entity.event/';
            }
    ...
    // Collection class for Event entities
    models.EventCollection = Backbone.Collection.extend({
        model: models.Event,
        url: "http://localhost:29373/CS230-PZ-3611/webresources/dusanstankovic3611.cs230.entity.event/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
...
$(function () {
    ...
    var AppRouter = Backbone.Router.extend({
        ...
        list: function () {
            this.collection = new models.EventCollection();
            var self = this;
            this.collection.fetch({
                success: function () {
                    self.listView = new views.ListView({
                        model: self.collection,
                        // tpl-event-list-itemis template identifier for item
                        templateName: '#tpl-event-list-item'
                    });
        ...
        details: function (id) {
            if (this.collection) {
                ...
                this.view = new views.ModelView({
                    model: this.event,
                    // tpl-event-details is template identifier for chosen model element
                    templateName: '#tpl-event-details',
        ...
        create: function () {
            ...
            var self = this;
            var dataModel = new models.Event();
            // see isNew() method implementation in the model
            dataModel.notSynced = true;
            this.view = new views.ModelView({
                model: dataModel,
                collection: this.collection,
                // tpl-event-details is a template identifier for chosen model element
                templateName: '#tpl-event-details',
